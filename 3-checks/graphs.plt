...
set multiplot layout 2,1 title 'Regression testing Nuspell vs. Hunspell' font ',14'
...
plot \
'regression.tsv' u 0:7:5:6:8 w candlesticks lc rgb 'blueviolet' t 'verification' whiskerbars 1.5, \
...
plot \
'regression.tsv' u 0:7:5:6:8 w candlesticks t 'speed-up' whiskerbars 1.5, \
'' using 0:4:4:4:4 w candlesticks lt -1 lw 2 notitle, \
