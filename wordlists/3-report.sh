...
for file in `find */*/usr/share/dict -type f|sort`; do
	...
	if [ $filename = american-english -o $filename = british-english -o $filename = canadian-english -o $filename = catalan -o $filename = danish -o $filename = dutch -o $filename = esperanto -o $filename = french -o $filename = frisian -o $filename = galician-minimos -o $filename = italian -o $filename = klingon -o $filename = klingon-latin -o $filename = ngerman -o $filename = polish -o $filename = portuguese -o $filename = spanish -o $filename = swiss -o $filename = ukrainian ]; then
